...
public class King extends Mob {
	...
	{
		name = Dungeon.depth == Statistics.deepestFloor ? "Stizza, re di fisica" : "Stizza, CAPO SOVIET di fisica.";
	...
	public void die( Object cause ) {
		...
		yell( "Non puoi uccidermi, " + Dungeon.hero.heroClass.title() + "... Io sono... COMUNISTA..." );
	}
	...
	undeadLabel:
		...
		yell( "Sorgete, fuori corso bocciati da me!" );
	}
	...
	public String description() {
		return
			"Sergio Stizza. Porprietario del dipartimento e custode della laurea in fisica." +
			"Ha venduto la moglie, i figli, i suoi capelli e la sua vita per la sua Laurea." +
			"L'unico, il solo, il supremo, il rosso basso cuccioloso." +
			"Uccidilo pls.";
	}
	...
	public static class Undead extends Mob {
		...
		public String description() {
			return
				"Simonucci non sa dove sia ne' cosa stia facendo." +
				"Stizza vuole ucciderti, quindi crede che sia giusto ucciderti.";
		}
