...
public class Thief extends Mob {
	...
	public String description() {
		String desc =
			"I dipartimenti piu' bassi sono da sempre ghetti ebraici. " +
			"Alcuni di loro, inmancanza di soldi e sole, divennero pazzi. " +
			"Cosi' rubano cose alla povera gente come te";
