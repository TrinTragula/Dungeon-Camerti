...
public class Ghost extends NPC {
	...
	public String description() {
		return 
			"Martino e' a malapena visibile. " +
			"Tutto della sua espressione ti ricorda un Pepe the Frog.";
	}
	...
	private static final QuestHandler roseQuest = new QuestHandler() {
		private static final String TXT_ROSE1	=
			"Ciao matricola.. io.. ehm CAZZO CHE BELLISSIMA GIORNATA!.. eh? vero? " +
			"Io sto cercando il mio _computer_... " +
			"Quel FROCIO di Scarinci me lo ha fottuto.. credo.. lo prendi per favore?.. se ti va eh.. ";
		
		private static final String TXT_ROSE2	=
			"Per favore.. aiutami a trovare.. _il computer_...";
		
		private static final String TXT_ROSE3	= 
			"ECCOLO ECCOLO EVVIVA EVVIVA! " +
			"Ti regalo un po' di queste cose " +
			"anche se la mia religione mi vieterebbe la solidarieta'...";
	...
	private static final QuestHandler ratQuest = new QuestHandler() {
		private static final String TXT_RAT1	=
			"Ciao matricola.. io.. ehm CAZZO CHE BELLISSIMA GIORNATA!.. eh? vero? " +
			"Un _pakistano sporco_ ha rubato la mia ragazza.. cioe'.. ci stavo " +
			"pasturando capito.. mi aveva parlato una volta.. AMMAZZALO";
			
		private static final String TXT_RAT2	=
			"Per favore aiutami a.. _uccidere la minaccia pakistana comunista_...";
		
		private static final String TXT_RAT3	= 
			"EVVIVA hai ucciso il paksitano... " +
			"Ti regalo un po' di queste cose " +
			"anche se la mia religione mi vieterebbe la solidarieta'...";
	...
	private static final QuestHandler curseQuest = new QuestHandler() {
		private static final String TXT_CURSE1 =
			"Ciao matricola.. io.. ehm CAZZO CHE BELLISSIMA GIORNATA!.. eh? vero? " +
			"Una _maledizione_ mi rende beta.. cioe'.. ci stavo " +
			"pasturando capito.. mi aveva parlato una volta.. fammi essere alpha!";
		private static final String TXT_CURSE2 =
			"GRAZIE, %s! Finalmente non sono piu' un beta... " +
			"Ti regalo un po' di queste cose " +
			"anche se la mia religione mi vieterebbe la solidarieta'...";
		
		private static final String TXT_YES	= "Si', Martino.";
		private static final String TXT_NO	= "No, vola basso.";
