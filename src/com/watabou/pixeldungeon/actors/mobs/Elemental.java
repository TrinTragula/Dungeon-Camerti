...
public class Elemental extends Mob {
	...
	public String description() {
		return
			"Una papera con la testa in fiamme non molto disturbata dal fatto. " +
			"Roba strapotente che sputa fuoco e non la controlli manco per il cazzo.";
	}
