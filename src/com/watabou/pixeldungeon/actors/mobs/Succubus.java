...
public class Succubus extends Mob {
	...
	public String description() {
		return
			"Cinzia usera' la sua magia per tentare di sedurti. Se non ci cadrai, " +
			"verrai tremendamente ucciso. Ti puo charmare e rendere incapace di attaccare per qualche turno.";
	}
