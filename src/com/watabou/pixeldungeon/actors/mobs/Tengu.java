...
public class Tengu extends Mob {
	...
	{
		name = Dungeon.depth == Statistics.deepestFloor ? "Santini" : "la moglie di Santini";
	...
	public String description() {
		return
			"Santini, studia chimica e scopa puttanelle. " +
			"Le peggio trappole e le peggio infamie da sto coatto.";
	}
