...
public class Eye extends Mob {
	...
	private static final String TXT_DEATHGAZE_KILLED = "Lo sguardo di disprezzo di %s ti ha ucciso...";
	...
	public String description() {
		return
			"Stefano Mancini, il Mancini quello temibile e potente. " +
			"ATTENZIONE: guardandoti con disprezzo potrebbe anche ucciderti.";
	}
