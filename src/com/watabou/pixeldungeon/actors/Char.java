...
public abstract class Char extends Actor {
	...
	protected static final String TXT_HIT		= "Un attacco da %s colpisce %s. ";
	protected static final String TXT_KILL		= "%s ti ha staccato ogni capello... ";
	protected static final String TXT_DEFEAT	= "%s rendi beta %s ";
	
	private static final String TXT_YOU_MISSED	= "%s %s il tuo attacco ";
	private static final String TXT_SMB_MISSED	= "%s %s l'attaco mandato da: %s ";
	
	private static final String TXT_OUT_OF_PARALYSIS	= "Le forti bestemmie hanno svegliato %s dalla paralisi ";
