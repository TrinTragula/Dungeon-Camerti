...
public class Hero extends Char {
	...
	private static final String TXT_LEAVE = "Non puoi semplicemente smettere di fare fisica.";
	
	private static final String TXT_LEVEL_UP = "Sei passato ad un nuovo anno!";
	private static final String TXT_NEW_LEVEL = 
		"Benvenuto al tuo %d anno accademico! Buon per te. " +
		"Ora sei piu' figo e meni piu' forte.";
	
	public static final String TXT_YOU_NOW_HAVE	= "Hai ottenuto %s";
	
	private static final String TXT_SOMETHING_ELSE	= "C'e' altro qua";
	private static final String TXT_LOCKED_CHEST	= "Sfigato, non hai la chiave lol";
	private static final String TXT_LOCKED_DOOR		= "Niente chiave, bro";
	private static final String TXT_NOTICED_SMTH	= "Cazzo era quel rumore?";
	
	private static final String TXT_WAIT	= "Penso un turno ad accia <3";
	private static final String TXT_SEARCH	= "Cerco, collassando le funzioni d'onda";
	...
	public void add( Buff buff ) {
		...
		if (sprite != null) {
			if (buff instanceof Burning) {
				GLog.w( "Questa e' benzina, ed ora ti dai fuoco!" );
				interrupt();
			} else if (buff instanceof Paralysis) {
				GLog.w( "Sei diversamente abile!" );
				interrupt();
			} else if (buff instanceof Poison) {
				GLog.w( "Hai la diarrea!" );
				interrupt();
			} else if (buff instanceof Ooze) {
				GLog.w( "Un codnensatore ti scoppia in faccia tanto acido! Lavalo via!" );
			} else if (buff instanceof Roots) {
				GLog.w( "Non ti puoi muovere!" );
			} else if (buff instanceof Weakness) {
				GLog.w( "Ti senti depresso!" );
			} else if (buff instanceof Blindness) {
				GLog.w( "Chi ha spento la luce?" );
			} else if (buff instanceof Fury) {
				GLog.w( "Sta incazzato nero!" );
				sprite.showStatus( CharSprite.POSITIVE, "furious" );
			} else if (buff instanceof Charm) {
				GLog.w( "Sei affascinato! (no homo)" );
			}  else if (buff instanceof Cripple) {
				GLog.w( "Sei disgustato!" );
			} else if (buff instanceof Bleeding) {
				GLog.w( "Ti esce il sangue dal naso!" );
			} else if (buff instanceof Vertigo) {
				GLog.w( "Non capisci un cazzo e tutto giiiira" );
				interrupt();
			}
