...
public class CavesLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
		case Terrain.GRASS:
			return "Piante molto dubstep";
		case Terrain.HIGH_GRASS:
			return "Funghetti allucinogeni";
		case Terrain.WATER:
			return "Acqua fredda, per calmare i tuoi bollenti spiriti.";
		default:
	...
	public String tileDesc( int tile ) {
		...
		case Terrain.ENTRANCE:
			return "Scala che va su.";
		case Terrain.EXIT:
			return "Scala che va giu.";
		case Terrain.HIGH_GRASS:
			return "Falli di gomma altissimi bloccano la visuale.";
		case Terrain.WALL_DECO:
			return "Cazzo ma e' oro?";
		case Terrain.BOOKSHELF:
			return "Opuscoli per iscriversi a fisica.";
		default:
