...
public abstract class Level implements Bundlable {
	...
	public String tileDesc( int tile ) {
		...
		switch (tile) {
		case Terrain.CHASM:
			return "Non riesci a vedere il fondo.";
		case Terrain.WATER:
			return "Se prendi fuoco, bagnati.";
		case Terrain.ENTRANCE:
			return "Scale verso su.";
		case Terrain.EXIT:
		case Terrain.UNLOCKED_EXIT:
			return "Scale verso l'abisso.";
		case Terrain.EMBERS:
			return "Resti di cibo della mensa coprono il pavimento.";
		case Terrain.HIGH_GRASS:
			return "Una densa vegetazione copre la via.";
		case Terrain.LOCKED_DOOR:
			return "La porta e' chiusa, hai bisogno di 50 centesimi per aprirla.";
		case Terrain.LOCKED_EXIT:
			return "Delle sbarre ti impediscono di passare.";
		case Terrain.BARRICADE:
			return "Forse puoi dargli fuoco.";
		case Terrain.SIGN:
			return "Troppo lontano per leggerlo.";
		case Terrain.TOXIC_TRAP:
		case Terrain.FIRE_TRAP:
		case Terrain.PARALYTIC_TRAP:
		case Terrain.POISON_TRAP:
		...
		case Terrain.GRIPPING_TRAP:
		case Terrain.SUMMONING_TRAP:
			return "Se pisti su una trappola, la attiverai..";
		case Terrain.INACTIVE_TRAP:
			return "Qualche altro povero stronzo ha gia' attivato la trappola.";
		case Terrain.STATUE:
		case Terrain.STATUE_SP:
			return "Anna ha provato ad addobbar il diaprtimento, con scarsi risultati.";
		case Terrain.ALCHEMY:
			return "Butta qui un po' di ganja per avere qualche boost .";
		case Terrain.EMPTY_WELL:
			return "Il pozzo non contiene piu' Crescina.";
		default:
			if (tile >= Terrain.WATER_TILES) {
