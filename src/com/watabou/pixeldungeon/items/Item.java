...
public class Item implements Bundlable {
	...
	private static final String TXT_PACK_FULL	= "Il tuo zaino ikea non riesce a tenere anche %s";
	
	private static final String TXT_BROKEN		= "Per il troppo utilizzo, %s e' stato rubato da Ezio Greggio.";
	private static final String TXT_GONNA_BREAK	= "Per il troppo utilizzo, %s sara' presto rubato da Ezio Greggio";
	...
	public static final String AC_DROP		= "LASCIA";
	public static final String AC_THROW		= "TIRA";
