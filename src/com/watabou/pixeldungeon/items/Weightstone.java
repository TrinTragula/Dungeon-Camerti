...
public class Weightstone extends Item {
	...
	private static final String TXT_SELECT_WEAPON	= "Seleziona un'arma da bilanciare";
	private static final String TXT_FAST			= "Hai bilanciato %s per renderlo piu' veloce e piadico";
	private static final String TXT_ACCURATE		= "Hai bilanciato %s per renderlo piu' accurato e meno Martino";
	
	private static final float TIME_TO_APPLY = 2;
	
	private static final String AC_APPLY = "USA";
	
	{
		name = "Testa di Roberto";
	...
	public String info() {
		return
			"Puoi usare la testa di Roberto per affilare o bilanciare una tua arma.";
	}
	...
	public class WndBalance extends Window {
		...
		private static final String TXT_CHOICE = "Come vuoi bilanciare il tuo %s?";
		
		private static final String TXT_SPEED		= "Por la velocitad";
		private static final String TXT_ACCURACY	= "Accuratezza, baby";
		private static final String TXT_CANCEL		= "Ehm, no grazie";
