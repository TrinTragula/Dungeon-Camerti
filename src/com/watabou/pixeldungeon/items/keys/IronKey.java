...
public class IronKey extends Key {
	...
	private static final String TXT_FROM_DEPTH = "50 centesimi belli del dipartimento %d";

	public static int curDepthQuantity = 0;
	
	{
		name = "50 centesimi belli";
	...
	public String info() {
		return 
			"50 centesimi belli da dio, probabilmente stranieri. " +
			"Quale buon caffe' potrebbero dare?";
	}
}
