...
public class DewVial extends Item {
	...
	private static final String TXT_AUTO_DRINK	= "La fonte di Crescina e' stata svuotata per i tuoi capelli.";
	private static final String TXT_COLLECTED	= "Hai preso una goccia di Crescina.";
	private static final String TXT_FULL		= "La tua boccetta e' piena!";
	private static final String TXT_EMPTY		= "La tua boccetta e' vuota!";
	...
	public String info() {
		return 
			"Puoi conservare la goccia di Crescina per dopo in una boccetta. " +
			"Se la boccetta e' piena, in caso di morte " +
			"l aberrai automaticamente.";
	}
