...
public class Bomb extends Item {
		...
		if (Level.pit[cell]) {
			...
			for (int n : Level.NEIGHBOURS9) {
				...
				if (c >= 0 && c < Level.LENGTH) {
					...
					if (ch != null) {
						int dmg = Random.Int( 3 + Dungeon.depth, 10 + Dungeon.depth * 2 ) - Random.Int( ch.dr() );
						if (dmg > 0) {
							ch.damage( dmg, this );
							if (ch.isAlive()) {
								...
								GLog.n( "Ti sei fatto esplodere da solo..." );
							}
						}
					}
				}
	...
	public String info() {
		return
			"Una calcolatrice con un solo tasto ed un'unica operazione memorizzata. 1 diviso 0. Lancia e scappa.";
	}
}
