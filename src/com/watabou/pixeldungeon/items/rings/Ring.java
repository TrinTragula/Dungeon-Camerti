...
public class Ring extends EquipableItem {
	...
	private static final String TXT_UNEQUIP_MESSAGE = 
		"Puoi avere in bocca solo fino a due psicofarmaci alla volta. " +
		"Sputa uno dei tuoi psicofarmaci.";
	...
	public boolean doEquip( final Hero hero ) {
		...
		if (hero.belongings.ring1 != null && hero.belongings.ring2 != null) {
			...
			if (cursed) {
				equipCursed( hero );
				GLog.n( "your " + this + " tightens around your lingua painfully" );
			}
	...
	public String desc() {
		return 
			...
			"that glitters in the darkness. Who knows what effect it has when mangiato?";
	}
