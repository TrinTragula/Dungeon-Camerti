...
public class WndChooseWay extends Window {
	...
	public WndChooseWay( final TomeOfMastery tome, final HeroSubClass way1, final HeroSubClass way2 ) {
		...
		final String TXT_MASTERY	= "Che specialistica prenderai?";
		final String TXT_CANCEL		= "Scegliero' dopo";
	...
	public WndChooseWay( final TomeOfMastery tome, final HeroSubClass way ) {
		...
		final String TXT_REMASTERY	= "Vuoi ?respec? qualcosa %s?";
		
		final String TXT_OK		= "Si', voglio fare respec";
		final String TXT_CANCEL	= "Forse piu' tardi";
