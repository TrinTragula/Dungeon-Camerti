...
public class WndStory extends Window {
	...
	static {
		CHAPTERS.put( ID_SEWERS, 
			...
			"con la Laurea in Fisica, nascosta in fondo ai dipartimenti sottereanei, sorveglia da Re Stizza. \n\n" +
			"Ora sei finalmente giunto nel primo dipartimento, pronto a dare esami." +
			"Sei fottutmente stupido, e vuoi provare a laurearti lo stesso. A costo di diventare un Martino. " +
			"Tempo di studiare!" );
