...
public class WndTradeItem extends Window {
	...
	private static final String TXT_SALE		= "AAA VENDESI: %s - %dg";
	private static final String TXT_BUY			= "Compro per %dg";
	private static final String TXT_SELL		= "Vendo per %dg";
	private static final String TXT_SELL_1		= "Ne vendo 1 per %dg";
	private static final String TXT_SELL_ALL	= "Vendo tutto per %dg";
	private static final String TXT_CANCEL		= "Lascia perdere";
	
	private static final String TXT_SOLD	= "Hai venduto %s per %dg";
