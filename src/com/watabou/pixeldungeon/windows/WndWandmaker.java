...
public class WndWandmaker extends WndQuest {
	...
	private static final String TXT_MESSAGE	= 
		"Oh, ce l'hai fatta! Spero non ti abbia fatto troppo male. " +
		"Come promesso, puoi scegliere uno dei miei migliori falli di gomma.";
	private static final String TXT_BATTLE		= "Fallo da battaglia";
	private static final String TXT_NON_BATTLE	= "Fallo da non-battaglia";
	
	private static final String TXT_FARAWELL	= "Usalo bene ;), %s!";
