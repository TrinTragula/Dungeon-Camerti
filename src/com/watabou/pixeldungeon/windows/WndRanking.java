...
public class WndRanking extends WndTabbed {
	...
	private static final String TXT_ERROR		= "Nun se carica";
	
	private static final String TXT_STATS	= "Dati sperimentali";
	private static final String TXT_ITEMS	= "Oggetti";
	private static final String TXT_BADGES	= "Pecette";
	...
	private class StatsTab extends Group {
		...
		private static final String TXT_TITLE	= "Dipartimento %d %s";
		
		private static final String TXT_CHALLENGES	= "Crditi Liberi";
		
		private static final String TXT_HEALTH	= "Capelli";
		private static final String TXT_STR		= "Intelligenza";
		
		private static final String TXT_DURATION	= "Durata corso di studi";
		
		private static final String TXT_DEPTH	= "Massima profondita'";
		private static final String TXT_ENEMIES	= "Cose uccise";
		private static final String TXT_GOLD	= "Equazioni imparate";
		
		private static final String TXT_FOOD	= "Meme assaporati";
		private static final String TXT_ALCHEMY	= "Boost preparati";
		private static final String TXT_ANKHS	= "Ankhs usati";
