...
public class WndSettings extends Window {
	...
	private static final String TXT_ZOOM_DEFAULT	= "Zoom Normale";

	private static final String TXT_SCALE_UP		= "Scala la UI";
	private static final String TXT_IMMERSIVE		= "Modalita' Martino";
	
	private static final String TXT_MUSIC	= "Musica";
	
	private static final String TXT_SOUND	= "Suoni";
	
	private static final String TXT_BRIGHTNESS	= "Luminosita'";
	
	private static final String TXT_QUICKSLOT	= "Seconda slot veloce";
	
	private static final String TXT_SWITCH_PORT	= "Modalita' Portrait";
	private static final String TXT_SWITCH_LAND	= "Modalita' Landscape";
