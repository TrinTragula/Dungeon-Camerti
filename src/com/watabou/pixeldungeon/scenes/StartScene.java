...
public class StartScene extends PixelScene {
	...
	private static final String TXT_LOAD	= "Login Esse3";
	private static final String TXT_NEW		= "Iscrizione Esse3";
	
	private static final String TXT_ERASE		= "Cancella iscrizione";
	private static final String TXT_DPTH_LVL	= "Prof.: %d, Dip.: %d";
	
	private static final String TXT_REALLY	= "Vuoi veramente ricominciare?";
	private static final String TXT_WARNING	= "Tutti gli esami non saranno convalidati.";
	private static final String TXT_YES		= "Yup, yolo";
	private static final String TXT_NO		= "No, ridammi i miei cfu";
	
	private static final String TXT_UNLOCK	= "Per sbloccare Antonio, ammaza il terzo boss con un altro fisico.";
	
	private static final String TXT_WIN_THE_GAME = 
		"Per sbloccare i \"Crediti Liberi\", vinci il gioco con qualsiasi fisico.";
