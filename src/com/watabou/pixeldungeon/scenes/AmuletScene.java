...
public class AmuletScene extends PixelScene {
	...
	private static final String TXT_EXIT	= "Famola finita, va";
	private static final String TXT_STAY	= "No, voglio studiare ancora";
	...
	private static final String TXT = 
		"Puoi finalmente tenerla in mano, la luarea in Fisica. Usando il suo potere " +
		"potrai controllare l'universo, essere stuprato da Stefano Mancini o fare il disoccupato. " +
		"In ogni caso, ora sei uno di loro. Uno di loro. " +
		"Oppure puoi rimanere a fare lo studentello ancora un poco";
