...
public class GameScene extends PixelScene {
	...
	private static final String TXT_WELCOME			= "Benvenuto nel dipartimento n. %d di Fisica!";
	private static final String TXT_WELCOME_BACK	= "Bentornato nel dipartimento n. %d di Fisica!";
	private static final String TXT_NIGHT_MODE		= "Di notte si aggirano i pakistani, stai attento.";
	
	private static final String TXT_CHASM	= "Fai un casino della madonna camminando per i corridoi";
	private static final String TXT_WATER	= "Senti l'acqua fare splash slpash";
	private static final String TXT_GRASS	= "L'odore di maria e' forte nell'aria";
	private static final String TXT_SECRETS	= "Una strana atmosfera ti porta a pensare ai numeri paidici";
